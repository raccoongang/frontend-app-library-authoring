...
import {
  APP_INIT_ERROR, APP_READY, initialize, mergeConfig, subscribe, getConfig
...
mergeConfig({
  ...
  LIB_AUTHORING_ROUTER_BASENAME: process.env.LIB_AUTHORING_ROUTER_BASENAME,
  PUBLIC_PATH: "/",
});
  ...
  ReactDOM.render(
    <AppProvider store={store}>
      ...
      <main className="library-authoring__main-content">
        <Router basename={getConfig().LIB_AUTHORING_ROUTER_BASENAME}>
          <Switch>
